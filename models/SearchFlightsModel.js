...
function getFlights(departingAirportCode, arrivalAirportCode, dateOfTravel) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        */
        const searchQuery = "SELECT distinct fl.flight_no, fl.scheduled_departure_time ,  fl.scheduled_arrival_time,fl.leg_duration," +
            "fr.fare , fl.route_id, fl.leg_no " +
            "FROM flight_leg AS fl LEFT join flight AS f ON (fl.flight_no = f.flight_no)" +
            "left JOIN flight_workdays fw ON (fl.flight_no = fw.flight_no)" +
            ...
            "r.departure_airport_code = ? AND r.arrival_airport_code = ?;";
